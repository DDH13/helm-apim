...
| kubernetes.gatewayAPI | object | `{"annotations":{},"backendTLSPolicy":{"caCertificateSecret":"","enabled":false,"hostname":"localhost"},"defaultConfigMapCreation":false,"defaultTlsCreation":false,"enabled":false,"gatewayClass":{"name":"nginx"},"km":{"annotations":{},"enabled":true,"filters":[],"hostname":"km.wso2.com"},"labels":{},"tlsSecret":""}` | Kubernetes Gateway API configurations (alternative to Ingress) Requires Gateway API CRDs to be installed in the cluster https://gateway-api.sigs.k8s.io/ |
