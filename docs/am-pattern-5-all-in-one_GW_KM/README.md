...
- [Pattern 5: Helm Chart for Deployment of a Simple Scalable WSO2 API Manager](#pattern-5-helm-chart-for-deployment-of-a-simple-scalable-wso2-api-manager)
  - [Contents](#contents)
...
- Run the following commands to deploy the Helm charts:
  ...
  1. Deploy All-in-one
      ...
      ```bash
      helm install apim wso2/wso2am-all-in-one --version 4.5.0-2 -f default_values.yaml -n <namespace>
      ```

  2. Deploy KM

      ```bash
      helm install apim-km wso2/wso2am-acp --version 4.5.0-2 -f default_km_values.yaml -n <namespace>
      ```

  3. Deploy GW

      ```bash
      helm install apim-gw wso2/wso2am-gw --version 4.5.0-2 -f default_gw_values.yaml -n <namespace>
      ```
